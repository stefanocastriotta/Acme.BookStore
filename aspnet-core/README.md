...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 54e01707-2d3e-4945-a8ed-92b9a92de7f9
```

> `54e01707-2d3e-4945-a8ed-92b9a92de7f9` is the password of the certificate, you can change it to any password you want.
